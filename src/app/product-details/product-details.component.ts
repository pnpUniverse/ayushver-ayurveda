...
export class ProductDetailsComponent implements OnInit {
  ...
  products:any = [
    ...
    },
    {
      ...
      category: 'heart_care',
      product_description:'<p>Well heart Power is a trusted supplement for cardiovascular problems. It helps regulate bad cholesterol in the blood and prevents plaque formation in heart arteries. It clears toxins from your system and strengthens heart muscles. It also helps any inflammation and controls angina pain.</p><p><strong>Benefits: </strong> Useful in cardiovascular diseases. It helps regulate bad cholesterol in the blood. It clears toxins from your system and strengthens heart muscles</p><p><strong>Pack of 400gm Powder</strong></p>',
